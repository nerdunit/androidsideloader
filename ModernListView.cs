...
namespace AndroidSideloader
{
    public class ModernListView : NativeWindow
    {
        ...
        private static readonly Color RowDownloadedNormal = Color.FromArgb(28, 46, 44);
        private static readonly Color RowDownloadedAlt = Color.FromArgb(33, 52, 50);
        private static readonly Color RowDownloadedHover = Color.FromArgb(46, 70, 67);
